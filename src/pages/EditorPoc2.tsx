...
export default function EditorPoc2() {
  ...
  return (
    <div className="size-full bg-zinc-50 px-4 py-10 text-zinc-900 selection:bg-selection">
      <div className="mx-auto me-8 h-full max-w-2xl overflow-y-auto rounded-xl bg-white py-12 ps-2 pe-9 shadow-sm ring-1 ring-zinc-200">
        ...
        <Editor onChange={setContent} externalContent={externalContent} />
